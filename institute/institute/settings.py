...
SECRET_KEY = '4z@b#b#62zu20y8*fh0s-v*%q2x^@0gqruhet^(%#^mpk0#p7v'
...
MEDIA_ROOT = os.path.join(BASE_DIR, 'media')  # Absolute filesystem path to the directory that will hold
# user-uploaded files.
